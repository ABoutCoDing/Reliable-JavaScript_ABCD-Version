var Aop = require("./Aop"),
    returnValueCache = require("./returnValueCache.js"),
    ThirdParty = require("./ThirdPartyRestaurantApi.js"),
    memoizedRestaurantApi = require("./memoizedRestaurantApi.js");
...
Aop.around(
    ...
    function addMemoizationToGetRestaurantsWithinRadius(targetInfo) {
        ...
        Aop.around(
            ...
            returnValueCache.returnValueCache().advice, 
        api);
...
memoizedRestaurantApi.memoizedRestaurantApi().getRestaurantsNearConference(cuisine).then(
